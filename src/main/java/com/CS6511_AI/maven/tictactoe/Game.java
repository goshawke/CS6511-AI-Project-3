...
import com.fasterxml.jackson.databind.ObjectMapper;
import com.CS6511_AI.maven.tictactoe.Requests;
import com.CS6511_AI.maven.tictactoe.Move;
...
public class Game {
    ...
    private void initBoard() throws IOException {
        ...
        // My code
        String result = Requests.get_board_map(this.gameId);
    ...
    private void confirmMove(int x, int y) throws Exception {
        ...
        int result = Requests.make_move(this.gameId, this.TEAM_ID, x, y);
        if (result == -1) {
    ...
    private String getLastMove() throws Exception {
        List<Move> moveList= Requests.get_moves(this.gameId);
        ...
        if (lastMove == null) {
            ...
            return lastMove.getSymbol() + "," + lastMove.getMoveX() + "," + lastMove.getMoveY();
        }
    }
